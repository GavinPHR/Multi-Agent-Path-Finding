...
Requires opencv-contrib-python==4.1.0.25 and numpy
'''
import time
...
'''
You can set the CAPITALED_VARIABLES below
'''

# The side length of square grids (in px)
# Better to keep this unchanged
GRID_SIZE = 30

# The radius of the agents, should be >= GRID_SIZE/2
ROBOT_RADIUS= 110

'''
Opposite vertices of rectangles.
Will be processed using vertices_to_obsts() later.
Observe that the cbs-mapf package can take obstacles of arbitrary 
shapes but for simplicity, we only make rectangluar obtacles here.
'''
RECT_OBSTACLES = {0: [[0, 0], [1919, 1079]],  # Border
                  1: [[576, 277], [741, 389]], 
                  2: [[1154, 275], [1321, 390]], 
                  3: [[578, 718], [739, 827]], 
                  4: [[1153, 716], [1319, 828]]}

# Start positions of agents
START = [(331, 165),
         (1530, 165),
         (315, 951),
         (1530, 951)]
